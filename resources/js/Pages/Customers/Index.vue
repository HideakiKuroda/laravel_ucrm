...
const serchText = sessionStorage.getItem('serchKey');//検索枠内に文字を残す
const search = ref(serchText);

const searchCustomers = () => {
    sessionStorage.setItem('serchKey' , search.value ); //検索枠内に文字を残す
                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="container px-5 py-8 mx-auto">
                           ...
                           <div class="flex pl-4 my-4 lg:w-2/3 w-full mx-auto">
                            <div>
                                <input type="text" name="search" id="searchText1" v-model="search">
